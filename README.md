...
- 🧭 **Pemandu tulis — Merepek (bila kotak kosong)** — ramai orang beku tengok kotak kosong lepas tu tutup app. Bila kotak kosong, butang **"kepala serabut? jom aku pandu kau tulis"** muncul, buka kotak **merepek**: luah je apa dalam kepala secara berselerak — tak payah betul, tak payah teratur (boleh guna **suara**) — lepas tu AI kemaskan luahan tu jadi **satu prompt jelas**, kau preview dulu, tap "guna ni" terus masuk kotak input. Tujuan: turunkan halangan mula sampai tak boleh gagal, tanpa tekanan "kena tulis elok"
