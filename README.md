...
- 🧠 **Ingatan** — satu kotak nota latar belakang (apa kau tengah buat, audience, gaya jawapan yang kau nak) dengan suis on/off; ia disuntik ke setiap prompt yang diperbaiki supaya hasilnya relevan dengan matlamat sebenar kau kat AI tools lain. Buka/tutup dengan animasi smooth, disimpan dalam browser; tak terpakai dalam mod "Kemas je"
