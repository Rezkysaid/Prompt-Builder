...
- ✍️ **Cadangan permulaan ayat** — stuck kat perkataan pertama? Bila kotak kosong, app tunjuk chips rawak cara nak mula ("Terangkan…", "Tolong aku…", "Macam ni weh…", "Sebenarnya…", "Aku nak cerita…"); tap satu, ia isi permulaan dan kau sambung je. Ada butang shuffle untuk cadangan lain
