...
- ⚡ **Anti-overthink (lawan perfeksionis)** — untuk yang beku sebab terlebih fikir "kalau-kalau" sebelum menulis. Dua alat di panel input: **Laju je** — overlay freewrite bermasa (kira detik 60s + bar), kira momentum ("N patah — teruskan!"), nudge lembut kalau berhenti lama, dan pilihan **sorok teks** supaya tak boleh baca balik & perfect-kan di tengah jalan; bila habis, teks mengalir terus ke kotak input untuk di-Power-kan. **aku overthinking?** — tap bila spiral datang, keluar ayat reframe yang lawan terus kerisauan ("prompt tak perlu perfect", "takde gred A, ada 'cukup untuk mula'", "cakap macam biasa je") + butang shuffle & "ok, jom taip"
