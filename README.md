...
- 🧭 **Pemandu tulis (bila kotak kosong)** — ramai orang beku tengok kotak kosong lepas tu tutup app. Bila kotak kosong, butang **"kepala serabut? jom aku pandu kau tulis"** muncul, buka pemandu dengan dua pintu: **(1) Isi tempat kosong (Mad Libs)** — rangka ayat "Aku nak [kata kerja] [topik] untuk [siapa], bagi dalam bentuk [format]"; kau tap-tap chip & isi topik je, ayat penuh terbentuk depan mata, tap "guna ni" terus masuk kotak. **(2) Merepek** — luah idea berselerak (boleh guna suara), AI kemaskan jadi satu prompt jelas, tap "guna ni". Tujuan: turunkan halangan mula sampai tak boleh gagal
