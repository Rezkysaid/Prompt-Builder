...
- 🧠 **Ingatan konteks** — 3 slot nota latar belakang (apa kau tengah buat, audience, gaya jawapan yang kau nak) yang boleh di-tick aktif; ia disuntik ke setiap prompt yang diperbaiki supaya hasilnya relevan dengan matlamat sebenar kau kat AI tools lain. Disimpan dalam browser; tak terpakai dalam mod "Kemas je"
